...
;copy translations end
  ...
  !define MUI_FILE "VideoThumbnailCreator"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Video Thumbnail Creator"
  !define PRODUCT_SHORTCUT "Video Thumbnail Creator"
  !define PRODUCT_VERSION "1.3"
  
  !define MUI_ICON "video-thumbnail-creator-48b.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  OutFile "VideoThumbnailCreatorSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Video Thumbnail Creator" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Video Thumbnail Creator - User's Manual.url.lnk" "$INSTDIR\Video Thumbnail Creator - User's Manual.url" "" "$INSTDIR\Video Thumbnail Creator - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\VideoThumbnailCreatorShellExtx64.dll $SYSDIR\VideoThumbnailCreatorShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\VideoThumbnailCreatorShellExt_vs2008_w7_x86.dll $SYSDIR\VideoThumbnailCreatorShellExt.dll $SYSDIR
...
;Add files
 ...
 ; Delete $SYSDIR\VideoThumbnailCreatorShellExt.dll 
  File "CryptoObfuscator_Output\${MUI_FILE}.exe"
 ;  
  File "Video Thumbnail Creator - User's Manual.url";
  File "ddb.dat"
  ...
  File /oname=ffmpeg64.exe "c:\code\misc\=redist\newffmpeg-latest\ffmpeg64.exe"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Video Thumbnail Creator" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Video Thumbnail Creator" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\VideoThumbnailCreatorShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Video Thumbnail Creator"
  DeleteRegKey HKCU "Software\4dots Software\Video Thumbnail Creator"
...
Function .onInstSuccess
 ...
 ExecShell "" "http://www.4dots-software.com/video-thumbnail-creator/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/video-thumbnail-creator/how-to-use.php?afterinstall=true"
FunctionEnd
